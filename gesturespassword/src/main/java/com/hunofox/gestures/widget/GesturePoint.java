...
public class GesturePoint
{
    ...
    public void setPointState(int state)
    {
        ...
        switch (state)
        {
            case Constants.POINT_STATE_NORMAL:
                this.image.setImageResource(R.drawable.iv_big_gray_point);//iv_circle_empty_big
                break;

            case Constants.POINT_STATE_SELECTED:
                this.image.setImageResource(R.drawable.iv_big_blue_point);//iv_circle_normal
                break;

            case Constants.POINT_STATE_WRONG:
                this.image.setImageResource(R.drawable.iv_big_red_point);//iv_circle_error
                break;
    ...
    public boolean equals(Object obj) {
        ...
        return rightX == other.rightX && topY == other.topY;
    }
