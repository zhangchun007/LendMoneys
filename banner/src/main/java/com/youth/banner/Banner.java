...
/**
 * https://github.com/android-taoge/BannerView
 */
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    public Banner setIndicatorPadding(int padding) {
    ...
    public Banner setIndicatorSelectedResIdUnselectedResId(int mIndicatorSelectedResId, int mIndicatorUnselectedResId) {
        this.mIndicatorSelectedResId = mIndicatorSelectedResId;
        this.mIndicatorUnselectedResId = mIndicatorUnselectedResId;
        return this;
    }

    public Banner setIndicatorWidthHeight(boolean isReset, int mIndicatorWidth) {
        if (isReset) {
            this.mIndicatorWidth = indicatorSize;
            this.mIndicatorHeight = indicatorSize;
        } else {
            this.mIndicatorWidth = mIndicatorWidth;
            this.mIndicatorHeight = mIndicatorWidth;
        }
        return this;
    }
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            if (listener != null) {
                view.setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        listener.OnBannerClick(object, toRealPosition(position));
                    }
                });
            }
            return view;
    ...
    public Banner setOnBannerListener(Object object, OnBannerListener listener) {
        this.listener = listener;
        this.object = object;
        return this;
    }
