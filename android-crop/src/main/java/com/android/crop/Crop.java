...
public class Crop {
     ...
     */
    public static Crop of(Uri source) {
        return new Crop(source);
    }

    private Crop(Uri source) {
     ...
     */
    public static byte[] getOutput(Intent result) {
        return result.getByteArrayExtra(MediaStore.EXTRA_OUTPUT);
    }
