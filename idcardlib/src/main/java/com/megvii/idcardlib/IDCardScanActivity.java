...
import com.megvii.idcardlib.utils.ICamera;
import com.megvii.idcardlib.utils.ModelUtil;
import com.megvii.idcardlib.utils.RotaterUtil;
import com.megvii.idcardlib.utils.StatusBarCompat;
import com.megvii.idcardlib.view.IDCardGuide;
import com.megvii.idcardlib.view.IDCardGuideH;
...
public class IDCardScanActivity extends Activity implements TextureView.SurfaceTextureListener, Camera.PreviewCallback, View.OnClickListener {
    ...
    private boolean isCanDetected = false;//是否可以检测，5s超时后停止检测
