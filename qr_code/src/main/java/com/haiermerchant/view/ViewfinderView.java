...
package com.haiermerchant.view;
...
public final class ViewfinderView extends View {
  ...
  private static final int    CORNER_RECT_HEIGHT            =   66; //扫描区边角的高
  private static final int    SCANNER_LINE_MOVE_DISTANCE    =   5;  //扫描线移动距离
  private static final int    SCANNER_LINE_HEIGHT           =   5;  //扫描线宽度
  ...
  private void drawTextInfo(Canvas canvas, Rect frame) {
    ...
    canvas.drawText(labelText, frame.left + frame.width() / 2, frame.bottom + CORNER_RECT_HEIGHT * 2f, paint);
  }
