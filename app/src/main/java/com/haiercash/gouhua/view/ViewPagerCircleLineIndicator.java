...
public class ViewPagerCircleLineIndicator extends View {
    private Path mPath;
    ...
    public ViewPagerCircleLineIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void setStyleable(Context context, AttributeSet attrs) {
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.ViewPager_Indicator);
        mSelected_color = array.getColor(R.styleable.ViewPager_Indicator_vpi_selected_color, 0xffffffff);
        mDefault_color = array.getColor(R.styleable.ViewPager_Indicator_vpi_default_color, 0xffcdcdcd);
        mRadius = array.getDimension(R.styleable.ViewPager_Indicator_vpi_radius, 20);//px
        mRadiusSelected = array.getDimension(R.styleable.ViewPager_Indicator_vpi_radius_selected, mRadius);//px
        mLength = array.getDimension(R.styleable.ViewPager_Indicator_vpi_length, 2 * mRadius);//px
        mDistance = array.getDimension(R.styleable.ViewPager_Indicator_vpi_distance, 3 * mRadius);//px
        mDistanceType = array.getInteger(R.styleable.ViewPager_Indicator_vpi_distanceType, DistanceType.BY_RADIUS);
        mIndicatorType = array.getInteger(R.styleable.ViewPager_Indicator_vpi_indicatorType, IndicatorType.CIRCLE);
        mNum = array.getInteger(R.styleable.ViewPager_Indicator_vpi_num, 0);
        mAnimation = array.getBoolean(R.styleable.ViewPager_Indicator_vpi_animation, true);
        array.recycle();
...
//                } else {
                    ...
                    for (int i = mPosition + 3; i <= mNum; i++) {
                        canvas.drawCircle(-(mNum) * 0.5f * mDistance + i * mDistance, 0, mRadius, paintFill);
                    }
...
//                }
    ...
    private void changePoint() {
        ...
        if (mPosition == mNum - 1 && !mIsLeft) {//第一个 右滑  0-->4
            ...
            } else if (CheckUtil.isEqual(mPercent, 1)) {//圆
     ...
     * @param num
     */
    public ViewPagerCircleLineIndicator setNum(int num) {
        mNum = num;
        invalidate();
        return this;
    }
     ...
     * @param indicatorType
     */
    public ViewPagerCircleLineIndicator setType(int indicatorType) {
     ...
     * @param radius
     */
    public ViewPagerCircleLineIndicator setRadius(float radius) {
        this.mRadius = radius;
        invalidate();
        return this;
    }
     ...
     * @param distance
     */
    public ViewPagerCircleLineIndicator setDistance(float distance) {
     ...
     * @param mDistanceType
     */
    public ViewPagerCircleLineIndicator setDistanceType(int mDistanceType) {
     ...
     * @return
     */
    public ViewPagerCircleLineIndicator setViewPager(ViewPager viewPager) {
     ...
     * @return
     */
    public ViewPagerCircleLineIndicator setViewPager(ViewPager viewpager, int CycleNumber) {
     ...
     * @return
     */
    public ViewPagerCircleLineIndicator setViewPager(ViewPager viewPager, boolean isInfiniteCircle) {
     ...
     * @return
     */
    public ViewPagerCircleLineIndicator setViewPager(ViewPager viewpager, int CycleNumber, boolean isInfiniteCircle) {
        mNum = CycleNumber;
